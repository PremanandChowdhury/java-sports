...
import { items } from "./MockData/Kits";
        ...
        <div className="bg-white ">
            <div className='bg-white justify-center relative'>
                <div className=' p-3 bg-grey/1'>
                    <div className=''>
                        <span className=' pl-[9%]  font-Lato text-[16px] font-700 align-middle'>Home {`>>`} Balls {`>>`} <span className='text-red-500'>All</span></span>
                    </div>
                </div>
                                    ...
                                    <ul class="w-48 text-sm font-medium text-gray-900 bg-white">
                                        ...
                                        <li class="w-full">
                                            <div class="flex items-center ps-3">
                                                ...
                                                <label className={`${labelWrapper}`} htmlFor="Bags" id="Bags">Red Leather</label>
                                            </div>
                                        </li>
                                        <li class="w-full">
                                            <div class="flex items-center ps-3">
                                                <input onClick={() => handleFilterButtonClick(event.target.value)} type="checkbox" name="" value="red" id="" />
                                                <label htmlFor="Bags" className={`${labelWrapper}`} id="Bags">White Leather</label>
                                            </div>
                                        </li>
                                    </ul>
                                    <div className='flex'>
                                    ...
                                    <ul class="w-48 text-sm font-medium text-gray-900 bg-white">
                                        ...
                                        <li class="w-full">
                                            <div class="flex items-center ps-3">
                                                ...
                                                <label htmlFor="size4" className={`${labelWrapper}`} id="Bags">Single Ball</label>
                                            </div>
                                        </li>
                                        <li class="w-full">
                                            <div class="flex items-center ps-3">
                                                <input onClick={() => handleFilterButtonClick(event.target.value)} type="checkbox" name="" value="red" id="size6" />
                                                <label htmlFor="size6" className={`${labelWrapper}`} id="Bags">Pack of 3</label>
                                            </div>
                                        </li>
                                        <li class="w-full">
                                            <div class="flex items-center ps-3">
                                                <input onClick={() => handleFilterButtonClick(event.target.value)} type="checkbox" name="" value="black" id="" />
                                                <label htmlFor="Bags" className={`${labelWrapper}`} id="Bags">Pack of 6</label>
                                            </div>
                                        </li>
                                        <li class="w-full">
                                            <div class="flex items-center ps-3">
                                                <input onClick={() => handleFilterButtonClick(event.target.value)} type="checkbox" name="" value="black" id="" />
                                                <label htmlFor="Bags" className={`${labelWrapper}`} id="Bags">Pack of 12</label>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                        ...
                        <div className='flex flex-col'>
                            ...
                            <ul class="w-48 text-sm font-medium text-gray-900 bg-white">
                                ...
                                <li class="w-full">
                                    <div class="flex items-center ps-3">
                                        <input onClick={() => handleFilterButtonClick(event.target.value)} type="checkbox" name="" value="black" id="" />
                                        <label htmlFor="Bags" className={`${labelWrapper}`} id="Bags">Parctice</label>
                                    </div>
                                </li>
                                <li class="w-full">
                                            <div class="flex items-center ps-3">
                                                <input onClick={() => handleFilterButtonClick(event.target.value)} type="checkbox" name="" value="black" id="" />
                                                <label htmlFor="Bags" className={`${labelWrapper}`} id="Bags">Tennis Ball</label>
                                            </div>
                                        </li>
                            </ul>
                            <div className='flex'>
                            ...
                            <ul class="w-48 text-sm font-medium text-gray-900 bg-white">
                                ...
                                <li class="w-full">
                                    <div class="flex items-center ps-3">
                                        <input onClick={() => handleFilterButtonClick(event.target.value)} type="checkbox" name="" value="white" id="size4" />
                                        <label htmlFor="size4" className={`${labelWrapper}`} id="Bags">Pack of 3</label>
                                    </div>
                                </li>
                                <li class="w-full">
                                    <div class="flex items-center ps-3">
                                        <input onClick={() => handleFilterButtonClick(event.target.value)} type="checkbox" name="" value="red" id="size6" />
                                        <label htmlFor="size6" className={`${labelWrapper}`} id="Bags">Pack of 6</label>
                                    </div>
                                </li>
                                <li class="w-full">
                                    <div class="flex items-center ps-3">
