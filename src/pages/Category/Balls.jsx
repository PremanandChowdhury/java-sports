                    ...
                    {MenuToggle && (
                        <div className='bg-white  absolute left-[-400px] top-[100px] border-2 xl:hidden p-5 duration-1500 translate-x-[400px]'>
                              <div className='flex flex-col'>
                                <div className='flex'>
                                    <span className=' pl-2 text-xl font-Lato font-700'>Ball Type:</span>
                                </div>
                                <ul class="w-48 text-sm font-medium text-gray-900 bg-white">
                                    ...
                                    <li class="w-full">
                                        <div class="flex items-center ps-3">
                                            ...
                                            <label for="Grip-checkbox" class="w-full py-2 ms-1 text-xs font-Lato font-700">Red Leather</label>
                                        </div>
                                    </li>
                                    <li class="w-full">
                                        <div class="flex items-center ps-3">
                                            ...
                                            <label for="Stickers-checkbox" class="w-full py-2 ms-1 text-xs font-Lato font-700">Whtie Leather</label>
                                        </div>
                                    </li>
                                    <li class="w-full">
                                        <div class="flex items-center ps-3">
                                            <input id="Stickers-checkbox" type="checkbox" value="" class="w-4 h-4 text-gray-600 bg-gray-900 border-gray-900 rounded focus:ring-gray-500 dark:focus:ring-gray-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-1 " />
                                            <label for="Stickers-checkbox" class="w-full py-2 ms-1 text-xs font-Lato font-700">Practice</label>
                                        </div>
                                    </li>
                                    <li class="w-full">
                                        <div class="flex items-center ps-3">
                                            <input id="Stickers-checkbox" type="checkbox" value="" class="w-4 h-4 text-gray-600 bg-gray-900 border-gray-900 rounded focus:ring-gray-500 dark:focus:ring-gray-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-1 " />
                                            <label for="Stickers-checkbox" class="w-full py-2 ms-1 text-xs font-Lato font-700">Tennis Ball</label>
                                        </div>
                                    </li>
                                </ul>

                                <div className='flex'>
                                    <span className='pl-2 text-xl font-Lato font-700'>Quantity</span>
                                </div>
                                <ul class="w-48 text-sm font-medium text-gray-900 bg-white">
                                    <li class="w-full">
                                        <div class="flex items-center ps-3">
                                    ...
                                    <li class="w-full">
                                        <div class="flex items-center ps-3">
                                            ...
                                            <label for="Blue-checkbox" class="w-full py-2 ms-1 text-xs font-Lato font-700">Pack of 3</label>
                                        </div>
                                    </li>
                                    <li class="w-full">
                                        <div class="flex items-center ps-3">
                                            ...
                                            <label for="Green-checkbox" class="w-full py-2 ms-1 text-xs font-Lato font-700">Pack of 6</label>
                                        </div>
                                    </li>
                                    <li class="w-full">
                                        <div class="flex items-center ps-3">
                                            ...
                                            <label for="White-checkbox" class="w-full py-2 ms-1 text-xs font-Lato font-700">Pact of 12</label>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div className='flex flex-col'>
                                ...
                                <ul class="w-48 text-sm font-medium text-gray-900 bg-white">
                                    ...
                                    <li class="w-full">
                                        <div class="flex items-center ps-3">
                                            <input id="Stickers-checkbox" type="checkbox" value="" class="w-4 h-4 text-gray-600 bg-gray-900 border-gray-900 rounded focus:ring-gray-500 dark:focus:ring-gray-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-1 " />
                                            <label for="Stickers-checkbox" class="w-full py-2 ms-1 text-xs font-Lato font-700">White Leather</label>
                                        </div>
                                    </li>
                                    <li class="w-full">
                                        <div class="flex items-center ps-3">
                                ...
                                <ul class="w-48 text-sm font-medium text-gray-900 bg-white">
                                    ...
                                    <li class="w-full">
                                        <div class="flex items-center ps-3">
                                            <input id="White-checkbox" type="checkbox" value="" class="w-4 h-4 text-gray-600 bg-gray-900 border-gray-900 rounded focus:ring-gray-500 dark:focus:ring-gray-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-1 " />
                                            <label for="White-checkbox" class="w-full py-2 ms-1 text-xs font-Lato font-700">Pack of 12</label>
                                        </div>
                                    </li>
                                </ul>
                            </div>
