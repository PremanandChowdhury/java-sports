        ...
        <>
            ...
            <div className='bg-white justify-center relative'>
                <div className=' p-3 bg-grey/1'>
                    <div className=''>
                        <span className=' pl-[140px] max-lg:pl-9 font-Lato text-[16px] font-700 align-middle'>Home {`>>`} Shoes {`>>`} <span className='text-red-500'>All</span></span>
                    </div>
                </div>
                    ...
                    {MenuToggle && (
                        <div className='bg-white  absolute left-[-400px] top-[100px] border-2 xl:hidden p-5 duration-1500 translate-x-[400px]'>
                              <div className='flex flex-col'>
                                <div className='flex'>
                                    <span className=' pl-2 text-xl font-Lato font-700'>Shoes Type:</span>
                                </div>
                                <ul class="w-48 text-sm font-medium text-gray-900 bg-white">
                                    ...
                                    <li class="w-full">
                                        <div class="flex items-center ps-3">
                                            ...
                                            <label for="Grip-checkbox" class="w-full py-2 ms-1 text-xs font-Lato font-700">Spikes</label>
                                        </div>
                                    </li>
                                    <li class="w-full">
                                        <div class="flex items-center ps-3">
                                            ...
                                            <label for="Stickers-checkbox" class="w-full py-2 ms-1 text-xs font-Lato font-700">Rubber Studs</label>
                                        </div>
                                    </li>
                                    <li class="w-full">
                                        <div class="flex items-center ps-3">
                                            <input id="Stickers-checkbox" type="checkbox" value="" class="w-4 h-4 text-gray-600 bg-gray-900 border-gray-900 rounded focus:ring-gray-500 dark:focus:ring-gray-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-1 " />
                                            <label for="Stickers-checkbox" class="w-full py-2 ms-1 text-xs font-Lato font-700">Turf Shoes</label>
                                        </div>
                                    </li>
                                ...
                                <ul class="w-48 text-sm font-medium text-gray-900 bg-white">
                                    ...
                                    <li class="w-full">
                                        <div class="flex items-center ps-3">
                                            ...
                                            <label for="Blue-checkbox" class="w-full py-2 ms-1 text-xs font-Lato font-700">UK 7</label>
                                        </div>
                                    </li>
                                    <li class="w-full">
                                        <div class="flex items-center ps-3">
                                            ...
                                            <label for="Green-checkbox" class="w-full py-2 ms-1 text-xs font-Lato font-700">UK 8</label>
                                        </div>
                                    </li>
                                    <li class="w-full">
                                        <div class="flex items-center ps-3">
                                            ...
                                            <label for="White-checkbox" class="w-full py-2 ms-1 text-xs font-Lato font-700">UK 9</label>
                                        </div>
                                    </li>
                                    <li class="w-full">
                                        <div className="flex items-center ps-3">
                                            ...
                                            <label for="Black-checkbox" class="w-full py-2 ms-1 text-xs font-Lato font-700">UK 10</label>
                                        </div>
                                    </li>
                                </ul>
                            </div>
